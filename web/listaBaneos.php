...
<head>
	<base href="">
	<title>Lista Bans - Fivem StaffPanel</title>
	<meta charset="utf-8" />
					...
					<div class="toolbar" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
							...
							<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
								...
								<!--begin::Title-->
								<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Lista de Personas Baneadas
								</h1>
								<!--end::Title-->
								<!--begin::Separator-->
				...
				if (obj.Status == "Success") {
					for (let x in obj.Result) {
						...
						<tr>
							...
							<td>${permanente}</td>
							<td><button class="btn btn-light-warning" onclick="unban('${obj.Result[x].identifier}')">Desbanear</button></td>
						</tr>
						`
						if(times == 0){
