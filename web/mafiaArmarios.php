...
<body id="kt_body"
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Inventario Bandas
                                </h1>
                            ...
                            <div class="card card-flush h-xl-100" style="height: 700px;">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">Armario de la Banda</span>
    ...
    const yourFunction = async () => {
        ...
        var url = "http://yourapi.com/api/getMafiaArmarios";
