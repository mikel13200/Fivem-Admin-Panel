...
<head>
	<base href="">
	<title>Buscar Hexadecimal - Fivem StaffPanel</title>
	<meta charset="utf-8" />
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="toolbar" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
							...
							<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
								...
								<!--begin::Title-->
								<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Buscar Hexadecimal
								</h1>
								<!--end::Title-->
								<!--begin::Separator-->
					...
					<div class="post d-flex flex-column-fluid rounded border p-10" id="kt_block_ui_2_target">
						...
						<input type="text" class="form-control" id="usernameToSearch" placeholder="Hexadecimal del jugador" aria-label="Hexadecimal del jugador" aria-describedby="basic-addon2">
