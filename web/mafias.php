...
<body id="kt_body"
	...
	<script>
			var url = "http://yourapi.com/api/getMafiaList";
			...
			if (xhr.readyState === 4) {
                ...
                if (obj.Status == "Success") {
                    for (let x in obj.Result) {
						var armarios = '<span class="badge badge-danger">No</span>';
						var esposas = '<span class="badge badge-danger">No</span>';
						if(obj.Result[x].armarios == '1'){
							var armarios = '<span class="badge badge-success">Si</span>';
						}
						if(obj.Result[x].aprove == '1'){
							var esposas = '<span class="badge badge-success">Si</span>';
						}
                        var rowHTML = `
                        <tr>

                            <td>${obj.Result[x].groupid}</td>
                            <td>${obj.Result[x].name}</td>
                            <td>${esposas}</td>
                            <td>${armarios}</td>
                            <td><a href="mafiaMembers.php?id=${obj.Result[x].groupid}" class="btn btn-primary me-2 mb-2">Miembros</a></td>
														<td><a href="mafiaArmarios.php?id=${obj.Result[x].groupid}" class="btn btn-warning me-2 mb-2">Armarios</a></td>
                        </tr>
                        `
