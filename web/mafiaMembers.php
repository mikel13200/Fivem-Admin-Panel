...
<body id="kt_body"
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Lista de Bandas
                                </h1>
                                <!--end::Title-->
                                <!--begin::Separator-->
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-gray-800">Miembros de la Banda</span>
                                    </h3>
                                    <!--end::Toolbar-->
                                </div>
                                <!--end::Header-->
    ...
    const yourFunction = async () => {
      ...
      var url = "http://yourapi.com/api/getMafiaMembers";
          ...
          if (xhr.readyState === 4) {
              ...
              if (obj.Status == "Success") {
                  for (let x in obj.Result) {
                    ...
                    var license = null;
                    await delay(100);
                    var url = "http://yourapi.com/api/getMafiaMembersInfo";
                    ...
                    xhr2.onreadystatechange = function () {
                      if (xhr2.readyState === 4) {
                          var jsonParsed = JSON.parse(xhr2.responseText);
                          if (obj.Status == "Success") {
                            steamName = jsonParsed.Result[0].name;
                            firstName = jsonParsed.Result[0].firstname;
                            lastname = jsonParsed.Result[0].lastname;
                            license = jsonParsed.Result[0].license;
                            var star1 = '';
                            var star2 = '';
                            var star3 = '';
                            var star4 = '';
                            var star5 = '';
                            if(obj.Result[x].rank == 1){
                              star1 = 'checked';
                            } else if(obj.Result[x].rank == 2){
                              star2 = 'checked';
                              star1 = 'checked';
                            } else if(obj.Result[x].rank == 3){
                              star3 = 'checked';
                              star2 = 'checked';
                              star1 = 'checked';
                            } else if(obj.Result[x].rank == 4){
                              star4 = 'checked';
                              star3 = 'checked';
                              star2 = 'checked';
                              star1 = 'checked';
                            } else if(obj.Result[x].rank == 5){
                              star5 = 'checked';
                              star4 = 'checked';
                              star3 = 'checked';
                              star2 = 'checked';
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">${license}</a>
                                </td>
                                <td>
                                    <div class="rating">
                            ...
                            console.log("No se ha podido encontrar a un usuario")
                          }
                      }};

                    var data2 = `{"identifier": "${obj.Result[x].identifier}"}`;
