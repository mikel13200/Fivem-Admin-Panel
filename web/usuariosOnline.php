...
<head>
	<base href="">
	<title>Usuarios Online - Fivem StaffPanel</title>
	<meta charset="utf-8" />
...
<body id="kt_body"
	...
	<script>
			var url = "http://yourapi.com/api/getOnlineUsers";
                ...
                if (obj.Status == "Success") {
                    for (let x in obj.Result) {
                        ...
                        <tr>
                            ...
                            <td>${obj.Result[x].id}</td>
                            <td><a href="account/overview.php?identifier=${obj.Result[x].identifiers[0]}" class="text-dark text-hover-primary">${obj.Result[x].name}</a></td>
                            <td>${obj.Result[x].identifiers[0]}</td>
                            <td>$${obj.Result[x].identifiers[1]}</td>
                            <td>${obj.Result[x].ping}</td>
                        </tr>
                        `
